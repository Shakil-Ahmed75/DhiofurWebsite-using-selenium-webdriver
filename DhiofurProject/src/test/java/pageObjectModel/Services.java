...
public class Services {
	...
	WebElement servicesXpath;
	
	@FindBy(xpath = "/html[1]/body[1]/div[3]/header[1]/div[2]/div[1]/div[1]/div[2]/nav[1]/ul[1]/li[3]/ul[1]/li[1]/a[1]/span[1]")
	WebElement subServicesXapth;
	
	public WebElement servicesHover() {
		return servicesXpath;
		
	}
	public WebElement subServices() {
		return subServicesXapth;
